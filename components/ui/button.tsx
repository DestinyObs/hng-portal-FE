...
const buttonVariants = cva(
  "p-6 inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-body font-semibold transition-all cursor-pointer disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive active:bg-primary-400",
  {
    variants: {
      variant: {
        default: "bg-primary-blue text-white hover:bg-primary-200 active:bg-primary-400",
        destructive:
        ...
        outline:
          "border bg-transparent hover:bg-primary-200 hover:text-background border-primary-blue text-primary-blue active:bg-primary-400",
        secondary:
