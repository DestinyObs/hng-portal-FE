...
// Component for the instructional step cards (local to this page)
  ...
  return (
    <Card className="w-full max-w-lg border-0 shadow-none py-0">
      <CardHeader className="text-center px-0">
        <CardTitle className="text-h2 font-bold mb-4">
          Reset password
        </CardTitle>
        <p className={cn("text-subtitle", "text-muted-foreground")}>
          We sent a reset link to <span className="font-semibold text-foreground">{mockEmail}</span>
        </p>
      </CardHeader>
